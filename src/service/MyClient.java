package service;
import com.ls.demo.demo.MyServicePrx;
import com.ls.demo.demo.MyServicePrxHelper;
...
public class MyClient {
	...
	public static void main(String[] args) {
		...
		try{
			...
			Ice.ObjectPrx base = ic.stringToProxy("MyService:default -h 192.168.102.133 -p 10000");
